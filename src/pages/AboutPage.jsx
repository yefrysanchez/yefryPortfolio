      ...
      <main className="pt-[124px] px-[40px] pb-4 md:px-8 mx-auto max-w-[2550px]">
        <section className="xl:flex relative xl:min-h-screen ">
          <div className="text-shade1 flex-1 z-10 xl:w-1/2 2xl:w-1/3 mb-12">
            ...
            >
              <span>
                Passionate Front-end Developer dedicated to crafting intuitive
                user interfaces. With a focus on blending design and
                functionality, I transform concepts into responsive and engaging
                websites.
              </span>
              <span className="mt-4">
                I am constantly exploring new technologies to enhance user
                experiences and drive innovation in web development. I love
                baseball, video games, producing music, and all about computers
                from hardware to software. I am passionate about technology in
                general.
              </span>
            </motion.p>
          </div>
        ...
        <section className="my-40 ">
          ...
          <div className="font-alata text-2xl text-shade1">
            <motion.a
              ...
              whileInView={"animate"}
              target="_blank"
              href="https://www.credly.com/badges/7ac77b31-e544-4863-9845-c8f4c93f8b40/linked_in_profile"
              className=" transition  border-y border-sha py-20 flex items-center justify-between group lg:text-4xl lg:px-6"
            >
              <span className="lg:group-hover:translate-x-8 transition">
            ...
            <motion.a
              ...
              whileInView={"animate"}
              target="_blank"
              href="https://www.credly.com/badges/b6074a5a-a750-4142-b64d-c6ad47098995/linked_in_profile"
            ...
            <motion.a
              ...
              whileInView={"animate"}
              target="_blank"
              href="https://www.coursera.org/account/accomplishments/verify/VWMAQRSDT53A"
              className=" transition  border-b py-20 flex items-center justify-between group lg:text-4xl lg:px-6"
            >
              <span className="lg:group-hover:translate-x-8 transition ">
