  ...
  return (
    <main className="pt-[124px] px-[40px] pb-4 md:px-8 ">
      ...
      <section className="my-40 ">
        <h2 className="text-[50px] text-shade1 lg:text-[100px]  uppercase tracking-tighter leading-[0.9] font-semibold my-20 lg:text-center">
          skills
        </h2>
        <div className="text-shade1 text-6xl grid grid-cols-3 md:grid-cols-4 md:gap-y-20 gap-4 lg:grid-cols-9">
