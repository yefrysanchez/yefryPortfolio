...
const AboutPage = () => {
  ...
  return (
    <main className="pt-[124px] px-[40px] pb-4 md:px-8 ">
      ...
      <section className="my-40 ">
          <motion.h2 variants={fadeUp} initial="initial" viewport={{once:true}} whileInView={"animate"} className="text-[50px] text-shade1 lg:text-[100px]  uppercase tracking-tighter leading-[0.9] font-semibold mb-40 lg:text-center">Certifications</motion.h2>
