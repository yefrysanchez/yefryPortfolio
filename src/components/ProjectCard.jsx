...
const ProjectCard = () => {
  ...
  return (
    <div className="h-[560px] xl:h-[800px] w-full rounded-2xl overflow-hidden relative group">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 bg-shade3 opacity-0 group-hover:opacity-50 transition duration-500"></div>
    </div>
  )
}
